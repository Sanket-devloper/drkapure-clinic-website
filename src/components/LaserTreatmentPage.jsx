...
const defaultHeroImages = [
  'https://images.pexels.com/photos/7446683/pexels-photo-7446683.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  'https://images.pexels.com/photos/5069612/pexels-photo-5069612.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  'https://images.pexels.com/photos/7446672/pexels-photo-7446672.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  'https://images.pexels.com/photos/4586728/pexels-photo-4586728.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
]

const defaultGalleryImages = [
  'https://images.pexels.com/photos/4586741/pexels-photo-4586741.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  'https://images.pexels.com/photos/4586752/pexels-photo-4586752.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  'https://images.pexels.com/photos/4586749/pexels-photo-4586749.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  'https://images.pexels.com/photos/10600169/pexels-photo-10600169.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
]

const defaultTransformations = [
  {
    title: 'Tone and Texture Progress',
    before: 'https://images.pexels.com/photos/5619456/pexels-photo-5619456.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
    after: 'https://images.pexels.com/photos/10822254/pexels-photo-10822254.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  },
  {
    title: 'Pigment Correction Journey',
    before: 'https://images.pexels.com/photos/3738355/pexels-photo-3738355.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
    after: 'https://images.pexels.com/photos/5069609/pexels-photo-5069609.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  },
]

const defaultStats = [
  { label: 'Session Time', value: '20-60 min' },
  { label: 'Downtime', value: 'Low to Moderate' },
  { label: 'Plan Type', value: 'Session-Based' },
]
...
const fallbackImageDataUri =
  "data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='1200' height='900' viewBox='0 0 1200 900'%3E%3Cdefs%3E%3ClinearGradient id='g' x1='0' x2='1' y1='0' y2='1'%3E%3Cstop stop-color='%23f1f3f5'/%3E%3Cstop offset='1' stop-color='%23e9ecef'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='1200' height='900' fill='url(%23g)'/%3E%3Ctext x='50%25' y='50%25' text-anchor='middle' fill='%235a6578' font-size='36' font-family='Inter, Arial, sans-serif'%3ELaser treatment image%3C/text%3E%3C/svg%3E"
...
export default function LaserTreatmentPage({ treatment }) {
  if (!treatment) {
    return (
      <section className="section-padding bg-brand-bg min-h-screen">
        <div className="container-max text-center">
          ...
          <Link to="/services/laser" className="btn-primary mt-6 inline-flex">
            Back to Laser Services <ArrowRight size={16} />
          </Link>
        </div>
      </section>
    )
        ...
        <div className="container-max grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start lg:items-stretch">
          ...
          >
            ...
            >
              ...
              <Link to="/services/laser" className="btn-outline">
