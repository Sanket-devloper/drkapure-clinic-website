...
const defaultHeroImages = [
  ...
  'https://images.pexels.com/photos/5069432/pexels-photo-5069432.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
...
const defaultGalleryImages = [
  'https://images.pexels.com/photos/4586753/pexels-photo-4586753.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  'https://images.pexels.com/photos/4586727/pexels-photo-4586727.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
...
const defaultTransformations = [
  {
    title: 'Texture and Tone Progress',
  ...
  {
    title: 'Glow and Clarity Improvement',
    before: 'https://images.pexels.com/photos/5069464/pexels-photo-5069464.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
    after: 'https://images.pexels.com/photos/5069459/pexels-photo-5069459.jpeg?auto=compress&cs=tinysrgb&w=1600&fit=crop',
  },
]
...
const defaultStats = [
  ...
  { label: 'Plan Type', value: 'Concern-Based' },
]
...
const fallbackImageDataUri =
  "data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='1200' height='900' viewBox='0 0 1200 900'%3E%3Cdefs%3E%3ClinearGradient id='g' x1='0' x2='1' y1='0' y2='1'%3E%3Cstop stop-color='%23f1f3f5'/%3E%3Cstop offset='1' stop-color='%23e9ecef'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='1200' height='900' fill='url(%23g)'/%3E%3Ctext x='50%25' y='50%25' text-anchor='middle' fill='%235a6578' font-size='36' font-family='Inter, Arial, sans-serif'%3ESkin treatment image%3C/text%3E%3C/svg%3E"
...
export default function SkinTreatmentPage({ treatment }) {
  if (!treatment) {
    return (
      <section className="section-padding bg-brand-bg min-h-screen">
        <div className="container-max text-center">
          ...
          <Link to="/services/skin" className="btn-primary mt-6 inline-flex">
            Back to Skin Services <ArrowRight size={16} />
          </Link>
        </div>
      </section>
    )
        ...
        <div className="container-max grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start lg:items-stretch">
          ...
          >
            ...
            >
              ...
              <Link to="/services/skin" className="btn-outline">
