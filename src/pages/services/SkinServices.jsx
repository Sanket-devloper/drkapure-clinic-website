...
const skinRouteMap = {
  ...
  'anti-aging': '/treatments/skin/anti-aging',
  pigmentation: '/treatments/skin/pigmentation',
  hydrafacial: '/treatments/skin/hydrafacial',
  'medi-facial': '/treatments/skin/medi-facial',
  'skin-tightening': '/treatments/skin/skin-tightening',
  'glutathione-iv': '/treatments/skin/glutathione-iv',
  'vampire-facial': '/treatments/skin/vampire-facial',
  'skin-brightening': '/treatments/skin/skin-brightening',
  'scar-treatment': '/treatments/skin/scar-treatment',
}

const fallbackImageDataUri =
  "data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='1200' height='900' viewBox='0 0 1200 900'%3E%3Cdefs%3E%3ClinearGradient id='g' x1='0' x2='1' y1='0' y2='1'%3E%3Cstop stop-color='%23f1f3f5'/%3E%3Cstop offset='1' stop-color='%23e9ecef'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='1200' height='900' fill='url(%23g)'/%3E%3Ctext x='50%25' y='50%25' text-anchor='middle' fill='%235a6578' font-size='34' font-family='Inter, Arial, sans-serif'%3ESkin service image%3C/text%3E%3C/svg%3E"
      ...
      <section className="section-padding bg-gradient-to-br from-brand-section to-brand-bg">
        <div className="container-max">
          ...
          >
            ...
            >
              Complete Skin Treatment Portfolio
            </motion.h1>
            <motion.p
              variants={heroItem}
            ...
            >
              Explore dermatologist-led skin treatments for acne, pigmentation, anti-aging,
              hydrafacial hydration, OxyGeneo medi-facial glow work, skin tightening,
              glutathione IV wellness support, vampire facial rejuvenation, and scar correction.
            </motion.p>
            <motion.div
              variants={heroItem}
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {skinTreatments.map((service) => {
              const to = skinRouteMap[service.id] || `/treatments/skin/${service.id}`
