...
const hairRouteMap = {
  ...
  'gfc-therapy': '/treatments/hair/gfc-therapy',
  mesotherapy: '/treatments/hair/mesotherapy',
  'hair-transplant': '/treatments/hair/hair-transplant',
  'hair-regrowth': '/treatments/hair/hair-regrowth',
  'low-light-laser-treatment': '/treatments/hair/low-light-laser-treatment',
  'micro-needling': '/treatments/hair/micro-needling',
}

const fallbackImageDataUri =
  "data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='1200' height='900' viewBox='0 0 1200 900'%3E%3Cdefs%3E%3ClinearGradient id='g' x1='0' x2='1' y1='0' y2='1'%3E%3Cstop stop-color='%23f1f3f5'/%3E%3Cstop offset='1' stop-color='%23e9ecef'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='1200' height='900' fill='url(%23g)'/%3E%3Ctext x='50%25' y='50%25' text-anchor='middle' fill='%235a6578' font-size='34' font-family='Inter, Arial, sans-serif'%3EHair service image%3C/text%3E%3C/svg%3E"
      ...
      <section className="section-padding bg-gradient-to-br from-brand-section to-brand-bg">
        <div className="container-max">
          ...
          >
            ...
            >
              Complete Hair Treatment Portfolio
            </motion.h1>
            <motion.p
              variants={heroItem}
            ...
            >
              Explore evidence-led hair options including PRP, GFC, mesotherapy,
              microneedling, low-level laser therapy, hair transplant, and advanced regrowth protocols.
            </motion.p>
            <motion.div
              variants={heroItem}
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {hairTreatments.map((service) => {
              const to = hairRouteMap[service.id] || `/treatments/hair/${service.id}`
